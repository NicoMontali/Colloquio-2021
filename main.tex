...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\input{titlepage} %inserisce il frontespizio
...
\input{intro} %input permette il nesting, \include lo impedisce
...
\chapter*{Bibliografia} %inserisce la bibliografia nell'indice
\addcontentsline{toc}{chapter}{Bibliografia}
\printbibliography[heading=none] %inserisce le voci citate, non crea una doppia intestazione per la bibliografia
\end{document}